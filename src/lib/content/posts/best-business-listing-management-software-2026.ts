const markdown = `Before you buy listing software, score it on whether it catches NAP drift, duplicates, and coverage gaps - not on how many publisher logos fit on a slide. Demand canonical NAP, verified status across Google, Apple, Bing, and the directory network, a duplicate workflow that protects reviews, a shared workspace, and public pricing that matches your location count.
